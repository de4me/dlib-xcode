...
#include <dlib/algs.h>
#include <dlib/optimization_search_strategies_abstract.h>
#include <dlib/optimization_stop_strategies_abstract.h>
#include <dlib/optimization_line_search_abstract.h>
