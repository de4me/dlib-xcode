...
#include <dlib/array_kernel_abstract.h>
#include <dlib/graph_kernel_abstract.h>
#include <dlib/matrix_abstract.h>
#include <dlib/sparse_vector_abstract.h>
#include <dlib/structural_svm_problem_threaded_abstract.h>
#include <vector>
