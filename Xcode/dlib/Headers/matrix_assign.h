...
#include <dlib/matrix_subexp.h>
#include <dlib/enable_if.h>
#include <dlib/matrix_assign_fwd.h>
#include <dlib/matrix_default_mul.h>
#include <dlib/matrix_conj_trans.h>
#include <dlib/matrix_mat.h>
